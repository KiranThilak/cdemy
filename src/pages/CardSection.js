    ...
    <section className="text-gray-600  ">
      <div className="container px-5 py-24 mx-auto">
        ...
        <div className="flex flex-wrap -m-4">
            ...
            <NavLink to="/academyhome" className="flex rounded-lg h-full bg-gray-100 p-8 flex-col hover:bg-green-200 cursor-pointer">
              <div className="flex items-center mb-3">
                <div className="w-16 h-16 mr-3 inline-flex items-center justify-center rounded-full bg-blue-300 text-white flex-shrink-0">
                  <img src={academyIcon} alt="Code Academy" className="w-8 h-8" />
                </div>
          ...
          <div className="p-4 md:w-1/2">
            <NavLink to="/softwarehome" className="flex rounded-lg h-full bg-blue-100 p-8 flex-col hover:bg-green-100 cursor-pointer">
              <div className="flex items-center mb-3">
                <div className="w-16 h-16 mr-3 inline-flex items-center justify-center rounded-full  text-white flex-shrink-0">
                  <img src={softwareIcon} alt="Software Development" className="w-50 h-50" />
                </div>
